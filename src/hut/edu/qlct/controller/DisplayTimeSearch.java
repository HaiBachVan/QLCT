...
public class DisplayTimeSearch extends ListActivity {
	...
	private void fillData() {
		...
		String date = bundle.getString("Ngay");
		...
		System.out.println("TenNganSach: "
				+ db.getNameNganSach(Integer.parseInt(cursor.getString(0))));
		...
		if (cursor.moveToFirst()) {
			do {
				...
				if (date.equalsIgnoreCase(cursor.getString(4).toString())) {
